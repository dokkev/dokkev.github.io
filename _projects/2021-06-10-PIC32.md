---
layout: distill
title: Programming PIC32 with C
...
- Use the long header pins to connect the MPLAB Snap programmer to the breadboard. Pin 1 of the Snap is labeled with a black triangle. Connect the Snap - VDD to 3.3V and GND to GND. Connect PGD to PGED1 and PGC to PGEC1 of the PIC. Connect the Snap MCLR to MCLR of the PIC.
