...
QDD 하드웨어의 힘 투명성 특성을 활용한 제어 방식이 **Proprioceptive Actuation**입니다.
...
### 학습 기반 제어(RL)와의 적합성
QDD는 최근의 학습 기반 제어, 특히 **강화학습(Reinforcement Learning)** 기반 정책을 실제 로봇에 적용하는 데 유리한 하드웨어적 특성을 제공합니다.
이는 QDD가 학습 알고리즘 자체를 바꾸기 때문이 아니라, 정책이 전제하는 actuator behavior를 실제 시스템이 더 충실하게 재현할 수 있게 해주기 때문입니다.
