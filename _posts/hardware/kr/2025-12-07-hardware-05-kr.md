...
## FOC가 있어도 모터는 이상적인 토크원을 만들지 못합니다
...
## 로봇용 고토크밀도 모터일수록 제어가 더 예민해지는 이유
...
## Current sensing도 이미 "진실값"이 아닙니다
...
## $\tau = K_t i$ 는 편리한 근사이지, 항상 맞는 법칙은 아닙니다
